...
*/
public class Mongo_Meteo {
	
	static final String URL = "https://api.openweathermap.org/data/2.5/onecall?exclude=minutely";
	static final String CLE = "";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String url = URL + "&appid=" + CLE + "&lat=" + LAT + "&lon=" + LON + "&lng=" + LANG;
